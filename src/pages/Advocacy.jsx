      ...
      <div className="max-w-6xl mx-auto px-6 space-y-16">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
          ...
          <div className="space-y-2">
            ...
            <p className="mt-4 text-sm text-[#5C3558] max-w-md leading-relaxed">
              A warm introduction. Describe your advocacy mission, who you speak for,
              and the communities you stand beside. This sets the tone of the entire page.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1">
            <div className="bg-[#FFBEEB] rounded-[32px] p-10 shadow-md h-full">
              ...
              <p className="text-sm text-[#5C3558] leading-relaxed">
