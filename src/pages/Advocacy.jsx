              ...
              <div className="w-full lg:w-60 flex flex-col gap-4">
                <div className="flex gap-4">
                  <div className={`flex-1 h-32 ${bubble}`}>
                    <img
                      src={warriorOne}
                      alt="Warrior Woman group photo"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className={`w-24 h-32 ${bubble}`}>
                    <img
                      src={warriorThree}
                      alt="Shannon speaking"
                      className="w-full h-full object-cover"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <div className={`flex-1 h-28 ${bubble}`}>
                    <img
                      src={warriorTwo}
                      alt="Warrior Woman flyer"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div
                    className={`w-24 h-28 ${bubble} flex items-center justify-center text-[11px] text-[#ff84d9] font-perandory`}
                  >
                    More soon
                  </div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-60 flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div className={`w-24 h-28 ${bubble} flex items-center justify-center text-[11px] text-[#ff84d9] font-perandory`}>
                    More soon
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-8 w-full">
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-60 flex flex-col gap-4">
                <div className="flex gap-4">
                  <div className={`flex-1 h-32 ${bubble}`}>
                    <img src={warriorOne} alt="She Codes image 1" className="w-full h-full object-cover" />
                  </div>
                  <div className={`w-24 h-32 ${bubble}`}>
                    <img src={warriorThree} alt="She Codes image 2" className="w-full h-full object-cover" />
                  </div>
                </div>

                <div className="flex gap-4">
                  <div className={`flex-1 h-28 ${bubble}`}>
                    <img src={warriorTwo} alt="She Codes image 3" className="w-full h-full object-cover" />
                  </div>
                  <div className={`w-24 h-28 ${bubble} flex items-center justify-center text-[11px] text-[#ff84d9] font-perandory`}>
                    More soon
                  </div>
          ...
          <div className="space-y-8 w-full">
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-60 flex flex-col gap-4">
                <div className="flex gap-4">
                  <div className={`flex-1 h-32 ${bubble}`}>
                    <img src={warriorOne} alt="CLG image 1" className="w-full h-full object-cover" />
                  </div>
                  <div className={`w-24 h-32 ${bubble}`}>
                    <img src={warriorThree} alt="CLG image 2" className="w-full h-full object-cover" />
                  </div>
                </div>

                <div className="flex gap-4">
                  <div className={`flex-1 h-28 ${bubble}`}>
                    <img src={warriorTwo} alt="CLG image 3" className="w-full h-full object-cover" />
                  </div>
                  <div className={`w-24 h-28 ${bubble} flex items-center justify-center text-[11px] text-[#ff84d9] font-perandory`}>
                    More soon
                  </div>
          ...
          <div className="space-y-8 w-full">
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-60 flex flex-col gap-4">
                <div className="flex gap-4">
                  <div className={`flex-1 h-32 ${bubble}`}>
                    <img src={warriorOne} alt="HTC image 1" className="w-full h-full object-cover" />
                  </div>
                  <div className={`w-24 h-32 ${bubble}`}>
                    <img src={warriorThree} alt="HTC image 2" className="w-full h-full object-cover" />
                  </div>
                </div>

                <div className="flex gap-4">
                  <div className={`flex-1 h-28 ${bubble}`}>
                    <img src={warriorTwo} alt="HTC image 3" className="w-full h-full object-cover" />
                  </div>
                  <div className={`w-24 h-28 ${bubble} flex items-center justify-center text-[11px] text-[#ff84d9] font-perandory`}>
                    More soon
                  </div>
